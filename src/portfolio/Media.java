...
public class Media extends JDialog {
	...
	public Media() {
		...
		RestrictedTextField validar = new RestrictedTextField(txtNome, "abcdefghijklmnopqrstuvwxyzçãõíó ");
		validar.setLimit(25);
		RestrictedTextField validar1 = new RestrictedTextField(txtDisciplina, "abcdefghijklmnopqrstuvwxyzçãõíó");
		validar1.setLimit(10);
