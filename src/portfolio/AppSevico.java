...
public class AppSevico extends JDialog {
	...
	public AppSevico() {
		...
		lblNewLabel_3.setBounds(11, 189, 157, 14);
		...
		txtCarga.setBounds(155, 95, 114, 20);
		contentPanel.add(txtCarga);
		txtCarga.setColumns(10);
		
		txtValor = new JTextField();
		txtValor.setEditable(false);
		txtValor.setBounds(199, 187, 70, 20);
		...
		lblNewLabel_4.setBounds(10, 253, 177, 14);
		contentPanel.add(lblNewLabel_4);
		
		txtEstimativa = new JTextField();
		txtEstimativa.setBounds(199, 250, 70, 20);
